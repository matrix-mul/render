...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-heading text-sm font-medium group-data-[size=sm]/card:text-2xl p-2",
        className
      )}
      {...props}
    />
...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("text-xl p-2 text-muted-foreground", className)}
      {...props}
    />
  )
}
...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("px-4 text-[15px] group-data-[size=sm]/card:px-3", className)}
      {...props}
    />
  )
}
